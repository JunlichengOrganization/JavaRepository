...
public class LogAop {
    ...
    @Pointcut("@annotation(com.junlc.admin.core.log.annotation.MyLog)")
    ...
    public Object recordLog(ProceedingJoinPoint point) throws Throwable {
        ...
        com.junlc.admin.core.log.annotation.MyLog anno = targetMethod.getAnnotation(com.junlc.admin.core.log.annotation.MyLog.class);
...
//        actionLog.setCreateBy(ShiroUtil.getSubject().getId());
